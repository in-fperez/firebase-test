...
class ProductEditPaletitationScreen extends StatefulWidget {
  const ProductEditPaletitationScreen({Key? key}) : super(key: key);

  @override
  State<ProductEditPaletitationScreen> createState() =>
      _ProductEditPaletitationScreenState();
}

class _ProductEditPaletitationScreenState
    extends State<ProductEditPaletitationScreen> {
  @override
